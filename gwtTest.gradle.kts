...
java.sourceSets {
    "gwtTest" {
        ...
        runtimeClasspath += output + compileClasspath + project.java.sourceSets["main"].allJava.sourceDirectories + project.java.sourceSets["gwtTest"].allJava.sourceDirectories
    }
}
configurations {
