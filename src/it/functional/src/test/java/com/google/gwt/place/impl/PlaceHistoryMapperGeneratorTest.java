...
import net.ltgt.gwt.place.testplacemappers.NoFactoryImpl;
import net.ltgt.gwt.place.testplacemappers.WithFactoryImpl;
...
public class PlaceHistoryMapperGeneratorTest extends TestCase {
  ...
  public void testTopLevelWithFactory() {
    AbstractPlaceHistoryMapper<TokenizerFactory> subject = new WithFactoryImpl();
  ...
  public void testNestedWithFactory() {
    AbstractPlaceHistoryMapper<TokenizerFactory> subject = new PlaceHistoryMapperGeneratorTest_LocalWithFactoryImpl();
    TokenizerFactory factory = new TokenizerFactory();
    subject.setFactory(factory);
