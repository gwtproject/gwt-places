...
public class PlaceControllerTest extends TestCase {
  ...
  private static final class Canceler implements PlaceChangeRequestEvent.Handler {
  ...
  private static class SimpleHandler implements PlaceChangeEvent.Handler {
  ...
  private PlaceController placeController =
      new PlaceController(eventBus, delegate) {
        @Override
        Logger log() {
          return deadLogger;
        }
