...
public class PlaceHistoryHandlerTest extends TestCase {
  private static class MockHistorian implements PlaceHistoryHandler.Historian {
  ...
  private static final MyPlace PLACE1 = new MyPlace();

  private static final MyPlace PLACE2 = new MyPlace();
  ...
  protected void setUp() {
    ...
    placeController =
        new PlaceController(eventBus, new MockPlaceControllerDelegate()) {
          @Override
          Logger log() {
            return deadLogger;
          }
